...
from app.api.routes import analysis, coaching, drills, games, health, matchups, profile, strength, sync, time_pressure
...
app.include_router(time_pressure.router, prefix="/api")
